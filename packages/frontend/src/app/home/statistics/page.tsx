          ...
          <tbody>
            <tr>
              ...
              {data?.temperatures.map((row: any, i: number) => (
                <td key={i} className="border border-border p-2">{roundToTwoDecimals(row.averageTemp)}</td>
              ))}
            </tr>
            <tr>
              <td className="border border-border p-2">Highest temperature</td>
              {data?.temperatures.map((row: any, i: number) => (
                <td key={i} className="border border-border p-2">{roundToTwoDecimals(row.highestTemp)}</td>
              ))}
            </tr>
            <tr>
              <td className="border border-border p-2">Lowest temperature</td>
              {data?.temperatures.map((row: any, i: number) => (
                <td key={i} className="border border-border p-2">{roundToTwoDecimals(row.lowestTemp)}</td>
              ))}
            </tr>
          </tbody>
        </table>
